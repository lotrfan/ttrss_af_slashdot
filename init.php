<?php
# Shamelessly copied and slightly modified from http://tt-rss.org/forum/viewtopic.php?f=22&t=1836
class Af_Slashdot extends Plugin {
    private $host;

    function about() {
        return array(1.2,
            'Clean Slashdot posts and remove comments',
            'lotrfan, originally dandersson',
            false,
